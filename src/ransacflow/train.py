...
class RANSACFlowModel(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        F_0 = F.affine_grid(affine_mat, I_t.shape)
        I_s_warped = F.grid_sample(I_s, F_0)

        # predict flow and correct the flow generated by affine matrix
        F_st = self(I_s, I_t)
        F_0_st = F.grid_sample(F_0.permute(0, 3, 1, 2), F_st)

        # TODO calculate alignment error
